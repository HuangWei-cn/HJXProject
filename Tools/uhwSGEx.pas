...
type
    ...
    protected
        ...
        procedure DrawBody(Canvas: TCanvas); override;
        procedure DrawText(Canvas: TCanvas); override;
        function DrawPointStyle(Canvas: TCanvas; const Pt: TPoint; const Angle: Double; Style:
            TLinkBeginEndStyle; SIZE: Integer): TPoint; override;
    end;
    ...
    begin
        ...
        begin
            ...
            try
                ...
                // 0, brush);
                { 取文字绘制区域大小 }
                GdipF.MeasureString(graphic, PWideChar(TextToShow), StrLen(PWideChar(TextToShow)),
                    font, @gpRect, 0, @gpRect, nil, nil);
...
// gpFont, @gpRect, 0, @gpRect, nil, nil);
                ...
                GdipF.DrawString(gpGraphic, PWideChar(Wstr), StrLen(PWideChar(Wstr)),
                    gpFont, @gpRect, 0, gpBrush);
            finally
...
function TGPGraphicLink.DrawPointStyle(Canvas: TCanvas; const Pt: TPoint; const Angle: Double; Style:
    TLinkBeginEndStyle; SIZE: Integer): TPoint;
var
    ...
    begin
        try
            ...
            begin
                ...
                GdipF.DrawEllipse(gpGraphic, gpPen, PtRect.Left, PtRect.Top, PtRect.Width,
                    PtRect.Height);
            end;
        finally
            GdipF.DeletePen(gpPen);
                ...
                begin
                    ...
                    try
                        ...
                        begin
                            ...
                            ModifiedPolyLine[0] := DrawPointStyle(Canvas, Points[0], Angle,
                                BeginStyle, BeginSize);
                        end;
                        ...
                        begin
                            ...
                            ModifiedPolyLine[PointCount - 1] := DrawPointStyle(Canvas, Points[PointCount
                                - 1], Angle, EndStyle, EndSize);
                            ;
                        end;
                    finally
...
begin
    ...
    begin
        ...
        try
            ...
            // 计算文本输出所需要的宽和高
            Winapi.Windows.DrawText(Canvas.Handle, PChar(Text), Length(Text),
