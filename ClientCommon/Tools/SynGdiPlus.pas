...
{$A-}
  ...
  protected
    ...
    { ----------------  增加以下几个GDI+函数 ------------------ }
    CreateFontFamilyFromName: function(AName: PWideChar; fontCollection: Pointer; out fontFamily: THandle): TGdipStatus; stdcall;
    DeleteFontFamily: function(fontFamily: THandle): TGdipStatus; stdcall;
    CreateFont:function(fontFamily: THandle; emSize: Single; Style: Integer; Unit_: Integer; out font: THandle): TGdipStatus; stdcall;
  protected
...
const GdiPFullProcNames: array[0..73] of PChar =
